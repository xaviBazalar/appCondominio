...
@Component({
  selector: 'app-zona-parrilla',
  templateUrl: './zona-parrilla.page.html',
  styleUrls: ['./zona-parrilla.page.scss'],
})
export class ZonaParrillaPage implements OnInit {
  fecha:string="";
  hora:string="";
  ...
  registrarZonaParrilla(){

    if(this.fecha=="" || this.hora=="" || this.nro_invitados=="" || this.nro_parrilla==""){
      this.presentAlert();
    }else{
      
      const formDataReserva = new FormData()
      formDataReserva.append("reservaN","zona-parrilla");
      ...
      formDataReserva.append("nro_parrilla",this.nro_parrilla);
